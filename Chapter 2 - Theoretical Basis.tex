...
The EEG cap works with 8 channels(with 2 extra "ground" channels) on a 24bit resolution and a refresh rate of 250 hertz. The data is outputted via Bluetooth to a computer where it is processed.
